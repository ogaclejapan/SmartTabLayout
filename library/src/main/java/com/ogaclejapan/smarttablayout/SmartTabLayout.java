...
public class SmartTabLayout extends HorizontalScrollView {
    ...
    /**
     * Overriding indicator color with gradient when using this function,
     * Note : if this function not called, tab indicator will use default stl_indicatorColor
     * Usage : SmartTabLayout.setGradientIndicator(Color.rgb(1,1,1),Color.rgb(100,100,100))
     *
     * @param colorEnd are Color.rgb
     * @param colorStart are Color.rgb too
     * */
    public void setGradientIndicator(int colorStart, int colorEnd) {
        tabStrip.getGradientColor(true, colorStart, colorEnd);
    }
